...
Install the module as usual, see http://drupal.org/node/1897420 for
further information.
...
===================
The **"Advanced PIWIK rules"** is an additional functionality available in
the EO PIWIK feature. It allows to create custom rules for setting up
